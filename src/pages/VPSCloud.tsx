...
const VPSCloud: React.FC = () => {
  ...
  const formatPrice = (price: number | string | undefined | null): string => {
    if (price === undefined || price === null) {
      console.warn('VPSCloud: Preço undefined/null:', price)
      return '0,00'
    }
    ...
    if (typeof price === 'string') {
      ...
      if (isNaN(numValue)) {
        console.warn('VPSCloud: String inválida:', price)
        return '0,00'
      }
    } else if (typeof price === 'number') {
      if (isNaN(price) || !isFinite(price)) {
        console.warn('VPSCloud: Número inválido:', price)
        return '0,00'
      }
      numValue = price
    } else {
      console.warn('VPSCloud: Tipo não suportado:', typeof price, price)
      return '0,00'
    }
    ...
    const fetchVPSPlans = async () => {
      try {
        ...
        if (response && response.list && Array.isArray(response.list)) {
          ...
          console.warn('VPSCloud: Resposta inválida:', response)
          setVpsPlans([])
        }
      } catch (error) {
        console.error('Erro ao buscar planos VPS Cloud:', error)
        setVpsPlans([])
      } finally {
        setLoading(false)
      }
    ...
    <div className="min-h-screen bg-gray-50 py-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          >
            Servidores virtuais privados na nuvem com recursos garantidos, 
            escalabilidade instantânea e controle total sobre seu ambiente.
          </motion.p>
        </div>
        ...
        {vpsPlans.length > 0 ? (
          ...
          <div className="text-center py-12">
            <p className="text-gray-500 text-lg">Nenhum plano VPS Cloud disponível no momento.</p>
          </div>
        )}
        ...
        <div className="bg-white rounded-xl shadow-lg p-8 mb-16">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <p className="text-gray-600">Ajuste recursos instantaneamente conforme sua necessidade</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">Infraestrutura redundante com 99.9% de uptime garantido</p>
            </div>
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">SSDs NVMe e processadores de última geração</p>
            </div>
          </div>
        </div>
      </div>
